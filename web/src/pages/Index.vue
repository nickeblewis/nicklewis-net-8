...
<h1
                  class="text-2xl font-bold leading-7 text-green-700 sm:text-3xl sm:leading-9"
                  id="projects"
                >Through the lens</h1>
    ...
    <div class="overflow-x-hidden bg-gray-800">
      <div class="contact-me bg-background-secondary pt-16">
        <div class="container mx-auto text-xl pb-4 relative">
          <h2 class="font-bold mb-6 text-white" id="contact">Contact me:</h2>
            ...
            >
              ...
              <div class="flex flex-wrap mb-6 -mx-4">
                <div class="w-full md:w-1/2 mb-6 md:mb-0 px-4">
                  <label class="block mb-2 text-copy-primary text-white" for="name">Name</label>
                ...
                <div class="w-full px-4 md:w-1/2">
                  <label class="block text-copy-primary text-white mb-2" for="email">Email Address</label>
              ...
              <div class="w-full mb-12">
                <label class="block text-copy-primary mb-2 text-white" for="message">Message</label>
    ...
    <div class="overflow-x-hidden bg-black">
      <div class="contact-me bg-background-secondary pt-16">
        <div class="container mx-auto text-xl pb-4 relative">
          <h2 class="font-bold mb-6 text-white" id="contact">Join the newsletter:</h2>
            ...
            >
              ...
              <div class="flex flex-wrap mb-12 -mx-4">
                <div class="w-full px-4 md:w-full">
                  <label class="block text-copy-primary mb-2 text-white" for="email">Email Address</label>
