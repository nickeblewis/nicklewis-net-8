            ...
            <form
              ...
              <div class="flex flex-wrap -mx-3 mb-4">
                <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                  ...
                  <input v-model="formData.firstname" id="first-name" type="text" class="form-input w-full text-gray-300 border-red-500 focus:border-red-500" placeholder="Enter your first name" required />
                ...
                <div class="w-full md:w-1/2 px-3">
                  ...
                  <input v-model="formData.lastname" id="last-name" type="text" class="form-input w-full text-gray-300" placeholder="Enter your last name" required />
                </div>
              </div>
              <div class="flex flex-wrap -mx-3 mb-4">
                <div class="w-full px-3">
                  <label class="block text-gray-300 text-sm font-medium mb-1" for="email">Email <span class="text-red-600">*</span></label>
                  <input v-model="formData.email" id="email" type="email" class="form-input w-full text-gray-300" placeholder="Enter your email address" required />
                </div>
              </div>
              <div class="flex flex-wrap -mx-3 mb-4">
                <div class="w-full px-3">
                  <label class="block text-gray-300 text-sm font-medium mb-1" for="subject">Subject <span class="text-red-600">*</span></label>
                  <input v-model="formData.subject" id="subject" type="text" class="form-input w-full text-gray-300" placeholder="How can we help you?" required />
                </div>
              </div>
              ...
              <div class="flex flex-wrap -mx-3 mb-4">
                <div class="w-full px-3">
                  ...
                  <textarea v-model="formData.message" id="message" rows="4" class="form-textarea w-full text-gray-300" placeholder="Write your message"></textarea>
                </div>
              </div>
              <div class="flex flex-wrap -mx-3 mb-4">
                <div class="w-full px-3">
                  <label class="flex items-center">
                    <input v-model="formData.privacyagreed" type="checkbox" class="form-checkbox" />
