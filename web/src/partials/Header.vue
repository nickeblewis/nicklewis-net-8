        ...
        <div class="md:hidden">
          ...
          >
            <ul class="bg-gray-800 px-4 py-2">
              <li>
                <router-link to="/features" class="flex text-gray-300 hover:text-gray-200 py-2"
                  >Features</router-link
                >
              </li>
              <li>
                <router-link to="/pricing" class="flex text-gray-300 hover:text-gray-200 py-2"
                  >Pricing</router-link
                >
              </li>
              <li>
                <router-link to="/blog" class="flex text-gray-300 hover:text-gray-200 py-2"
                  >Blog</router-link
                >
              </li>
              <li>
                <router-link to="/about" class="flex text-gray-300 hover:text-gray-200 py-2"
                  >About us</router-link
                >
              </li>
